 ...
 * @author Ella, grid visualisation
 */
public class VisualisationUI 
{
	...
	private static Color backgroundcolor = CustomiseUIColours.settAsBackGroundColour();
	private static Color primarycolor = CustomiseUIColours.settAsPrimaryColour();
	private static Color accentcolor = CustomiseUIColours.setAsAccentColour();
	private static Color textcolor = CustomiseUIColours.settAsTextColour();
	/**
	...
	private void initialize() 
	{
		...
		frame.getContentPane().setForeground(primarycolor);
...
//---------------------------------------------- Set up tool bar menu------------------		
		...
		UIPanel toolBarPanel = new UIPanel(backgroundcolor);
		toolBarPanel.setBorder(BorderFactory.createLineBorder(primarycolor));
		...
		startBtn.setImage("/imgs/start.png", "/imgs/startRoll.png", 100, 75, false);
		...
		speed2Btn.setImage("/imgs/speed2.png","/imgs/speed2Roll.png" ,100 ,75, false);
		...
		speed1Btn.setImage("/imgs/speed1.png","/imgs/speed1Roll.png" ,100 ,75, false);
		...
		stopBtn.setImage("/imgs/stop.png","/imgs/stopRoll.png", 100, 75, false);
...
//--------------------------------New Search Button-------------------------
		UIButton btnNewSearch = new UIButton("Create New Search", backgroundcolor, accentcolor, primarycolor, textcolor);
...
//-------------------------------------Help Button------------------------------------
		UIButton btnHelp = new UIButton("", backgroundcolor, accentcolor, primarycolor, textcolor);
		
		btnHelp.setGridBag(toolBarPanel, 9, 0, 1, 1);
		btnHelp.setImage("/imgs/helpRollSmall.png", "/imgs/helpSmall.png", 60, 80, false);
...
//--------------------------------Selection Panel to choose which panel to show up on screen---------------
		UIPanel SelectionPanel = new UIPanel(backgroundcolor);
...
//----------------------------------Labelling which type of search is performing at the moment.--------------- 
		UILabel SearchTypeLbl = new UILabel(searchType, 20, primarycolor, backgroundcolor);
...
//-----------------------------------Grid Panel----------------------------
		...
		gridPanel.setBorder(BorderFactory.createLineBorder(primarycolor));
...
//----------------------------------Pseudocode Panel
		pseudoCodePanel.setBackground(backgroundcolor);
		pseudoCodePanel.setBorder(BorderFactory.createLineBorder(primarycolor));
		...
		pseudoCodeTextPane.setBackground(new Color(166,179,198));
...
//--------------------------------Data Structure(Stack/Queue) Panel--------------------------
		...
		dataStructPanel.setBorder(BorderFactory.createLineBorder(primarycolor));
...
//--------------------------------Graph Panel--------------------------
		...
		graphPanel.setBorder(BorderFactory.createLineBorder(primarycolor));
		graphPanel.setVisible(true);
	...
	private static void RadioButtonSetUp(JRadioButton radioButton, JPanel panel, int x, int y)
	{
		...
		radioButton.setForeground(primarycolor);
